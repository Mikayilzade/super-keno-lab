...
## Phase 18 checkpoint chain

Earlier checkpoints established:
- historical `Sürətli Şans` overlay but denominator unknown;
- 10→10 is mathematically +EV if operational, but current official surfaces conflict;
- mainstream bank cashback and most retail receipt stacks are excluded;
- Azərpoçt is a neutral distribution channel;
- RadioArena promo is current but product scope unresolved;
